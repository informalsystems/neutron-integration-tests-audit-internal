...
describe('Neutron / TGE / Auction', () => {
  ...
  beforeAll(async () => {
    ...
    for (const v of [
      ...
      'airdropAuctionLockdropVestingMigration2',
    ]) {
  ...
  describe('migrate TGE liquidity to PCL', () => {
    ...
    describe('execute migration handlers: lockdrop', () => {
      ...
      describe('migrate airdropAuctionLockdropVestingMigration2 participant', () => {
        let stateBefore: LiquidityMigrationState;
        it('gather state before migration', async () => {
          stateBefore = await gatherLiquidityMigrationState(
            neutronChain,
          ...
          console.log(
            `airdropAuctionLockdropVestingMigration2 migration state before:\n${JSON.stringify(
              stateBefore,
            )}`,
          );
        });
        ...
        it('check user voting power', async () => {
          ...
          isWithinRangeRel(
            +vp.power,
            votingPowerBeforeLockdrop['airdropAuctionLockdropVestingMigration2'],
            0.05,
          );
        });
        ...
        it('gather state after migration', async () => {
          ...
          console.log(
            `airdropAuctionLockdropVestingMigration2 migration state after:\n${JSON.stringify(
              stateAfter,
            )}`,
          );
        });
  ...
  describe('post migration claims and withdrawals', () => {
    ...
    describe('by airdropAuctionLockdropVestingMigration2', () => {
      it('no withdrawal available from XYK', async () => {
        // nor with withdrawal
        await expect(
          tgeWallets['airdropAuctionLockdropVestingMigration2'].executeContract(
            tgeMain.contracts.lockdrop,
            JSON.stringify({
              claim_rewards_and_optionally_unlock: {
                pool_type: 'USDC',
      ...
      it('gather state before withdrawal', async () => {
        ...
        console.log(
          `airdropAuctionLockdropVestingMigration2 state before withdrawal:\n${JSON.stringify(
            stateBefore,
          )}`,
        );
      });
      ...
      it('gather state after withdrawal', async () => {
        ...
        console.log(
          `airdropAuctionLockdropVestingMigration2 state after withdrawal:\n${JSON.stringify(
            stateAfter,
          )}`,
        );
      });
